    ...
    return (
      <div className="pop-title">
        <div className="pop-title-container">
          ...
          /> */}
          <Avatar size={50} src={<Image src={user?.providerData?.photoURL} />} />
        ...
        <div className="header-right">
          <div className="header-right-options">
            <div className="header-right-option">
              <span>
                <svg width="25" height="25" viewBox="0 0 25 25" className="la">
            ...
            <div className="header-right-option">
              <span>
                <Link to="/me/lists">
                  <svg width="25" height="25" viewBox="0 0 25 25" fill="none" className="la">
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
            ...
            <div className="header-right-option">
              <span>
                <svg width="25" height="25" viewBox="-293 409 25 25" className="la">
